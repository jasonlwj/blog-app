const listHelper = require('./helpers/dummy_helper')
...
describe('most blogs', () => {
	...
	test('when list has many blogs, equals the blog\'s author with the most blogs', () => {
...
describe('most likes', () => {
	...
	test('when list has many blogs, equals that blog\'s author with the most likes', () => {
